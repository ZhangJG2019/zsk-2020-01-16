      ...
      >
        <div class="registered">
          <img
            ...
            alt
            style="margin:20px auto;display:table-cell;cursor:pointer;"
          />
          <h3
            @click="shouye"
            style="font-family:SimSun;cursor:pointer;"
          >精准用药知识库</h3>
          <h4
            @click="shouye"
            style="font-family:Times new roman,Times roman;cursor:pointer;"
          >Precise Medicine Knowledge Base</h4>
          <div
